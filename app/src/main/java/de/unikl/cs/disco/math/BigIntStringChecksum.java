 ...
 ******************************************************************************/
package de.unikl.cs.disco.math;

import java.math.BigInteger;

import de.unikl.cs.disco.exceptions.SecretShareException;
import de.unikl.cs.disco.md5sum.Md5Checksummer;
import de.unikl.cs.disco.md5sum.Md5ChecksummerFactory;
    ...
    private static byte[] computeMd5ChecksumFull(String inAsHex2)
    {
       ...
       if (testonlyUseInternalMd5Impl)
       {
           ...
           md5summer = Md5ChecksummerFactory
               .createFromClassName("de.unikl.cs.disco.md5sum.Md5ChecksummerImpl");
       }
